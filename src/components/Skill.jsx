        ...
        <div className="overflow-hidden xl:w-full xl:h-[100vh] xl:p-8 p-6 xl:flex xl:flex-col xl:justify-center gap-[106px]">
              <div className="container xl:flex xl:flex-col md:flex md:flex-col md:justify-center  gap-24 xl:w-[100%]">
                  ...
                  <div className="xl:w-[1024px] md:w-full xl:h-[130.33px] xl:gap-[21.33px] md:flex md:flex-col md:justify-center ">
                      ...
                      <h1 className='font-[Roboto] xl:text-[4rem] md:text-[4rem] text-[3rem] font-bold'>My Expertise</h1>
                  </div>
                  <div className="xl:flex xl:flex-row xl:justify-center xl:gap-10 xl:w-[100%] md:w-full md:flex md:justify-center md:items-center flex flex-col gap-8">
                      ...
                      <div className="bg-[#F5FCFF] w-[340.33px] md:w-full h-[3650x] rounded-md shadow-md p-2 border-b-4 border-[#5E3BEE]">
                          ...
                          <div className="w-[341.33px] h-[194.33px] md:w-full">
                              ...
                              <p className='font-[Roboto] font-normal xl:leading-[1.5rem] leading-[1.5rem] md:leading-[2.5rem] md:w-[90%] xl:w-[90%] xl:text-[18px] md:text-[40px]  text-[#1C1E53]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                          </div>
                      </div>
                      <div className="bg-[#F5FCFF] w-[340.33px] md:w-full h-[3650x] rounded-md shadow-md p-2 ">
                      ...
                      <div className="bg-[#F5FCFF] w-[340.33px] md:w-full h-[3650x] rounded-md shadow-md p-2">
                          ...
                          <div className="w-[341.33px] h-[194.33px] md:w-full">
                              <h3 className='text-[28px] font-bold text-[#282938] my-4 font-[Roboto]'>Testing and Debuggin</h3>
                              <p className='font-[Roboto] font-normal xl:leading-[1.5rem] leading-[1.5rem] md:leading-[2.5rem] md:w-[90%] xl:w-[90%] xl:text-[18px] md:text-[40px]  text-[#1C1E53]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                          </div>
                      </div>
                      <div className="bg-[#F5FCFF] w-[340.33px] md:w-full h-[3650x] rounded-md shadow-md p-2">

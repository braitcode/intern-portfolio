...
const Footer = () => {
  return (
    <div>
        <div className="w-full bg-[#F5FCFF] p-12 xl:flex xl:flex-col xl:gap-10 xl:justify-center">
              <div className="xl:flex xl:flex-col xl:gap-28 flex flex-col gap-10">
                  <div className="xl:flex xl:flex-row xl:justify-between flex flex-col gap-4">
                      <div className="flex">
                          <img src={logo} alt="" className='w-[44px] h-[40px]' />
                          <p className='font-[Roboto] text-[25.21px] font-semibold'>JohnDev,</p>
                      </div>
                      <div className="">
                          <ul className='xl:flex gap-11 font-[Roboto] text-[21.33px]'>
                              <li>Home</li>
                              <li>Portfolio</li>
                              <li>About Me</li>
                              <li>Contact</li>
            ...
            <div className="xl:flex xl:flex-row xl:justify-between flex flex-col gap-4">
                ...
                <div className=""> 
                    <ul className='xl:flex xl:flex-row xl:gap-11 flex flex-col gap-2 font-[Roboto] text-[18px]'>
